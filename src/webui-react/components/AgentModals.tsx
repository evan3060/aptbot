    ...
    <>
      ...
      {isCreateOpen && (
        <div data-testid="create-agent-modal" className="fixed inset-0 z-[100] flex items-center justify-center p-4">
          ...
          <div className="relative w-full max-w-lg bg-white rounded-lg border border-slate-200 shadow-2xl overflow-hidden">
            {/* Header */}
            ...
            {/* Footer */}
            <div className="p-5 bg-neutral-50 border-t border-slate-200 flex justify-end gap-3">
              <button
